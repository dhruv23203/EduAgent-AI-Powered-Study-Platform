...
export default function RevisionPage() {
  ...
  return (
    <AppShell>
      <section className="rounded-lg bg-white p-6 shadow-soft dark:bg-white/10"><p className="section-kicker">Revision</p><h1 className="mt-2 text-3xl font-black">Covered-topic revision room</h1><p className="mt-2 max-w-2xl text-ink/65 dark:text-white/65">Revision focuses only on topics you have already touched or missed in quizzes.</p></section>
